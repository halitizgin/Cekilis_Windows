...
namespace Cekilis_Windows
{
    ...
    sealed partial class App : Application
    {
        ...
        void onCommandsRequested(SettingsPane settingsPane, SettingsPaneCommandsRequestedEventArgs e)
        {
            ...
            SettingsCommand defaultscommand = new SettingsCommand("hakkında", hakkindatitle,
            (handler) =>
            {
                Hakkinda hakkinda = new Hakkinda();
                hakkinda.Show();
            });
            SettingsCommand dilayaricommand = new SettingsCommand("dilayarları", dilayarititle,
            (handler2) =>
            {
            ...
            e.Request.ApplicationCommands.Add(dilayaricommand);
        }
    }
}
